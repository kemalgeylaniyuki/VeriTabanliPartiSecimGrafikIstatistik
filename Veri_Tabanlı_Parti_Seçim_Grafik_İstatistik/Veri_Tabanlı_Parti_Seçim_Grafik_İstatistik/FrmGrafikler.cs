...
namespace Veri_Tabanlı_Parti_Seçim_Grafik_İstatistik
{
    public partial class FrmGrafikler : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=LAPTOP-ES0PS9NQ;Initial Catalog=DBSECIMPROJE;Integrated Security=True");
        ...
        private void FrmGrafikler_Load(object sender, EventArgs e)
        {
            ...
            // veri okutmak için =  sqldatareader
            // dr isminde nesne türetildi ve komuttan gelen değer ile ilişklendirildi
            SqlDataReader dr = komut.ExecuteReader();
            while (dr.Read()) // okunduğu müddetçe
            {
                comboBox1.Items.Add(dr[0]); // dr den gelen sıfırıncı indexi ekle. yani ilçead
            }
            baglanti.Close();
